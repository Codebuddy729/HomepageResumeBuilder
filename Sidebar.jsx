...
{ 
    ...
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      ...
      <span class="fs-4 Naughty">Resume Builder</span>
    </a>
    <hr/>
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <a href="#" class={`nav-link text-white ${ selectedTab === "Dashboard" && "active"}`}>
      ...
      <li onClick={ ()=>{ setSelectedTab("Orders")
        ...
        <a href="#" class={`nav-link text-white ${ selectedTab === "Orders" && "active"}`}>
      ...
      <li onClick={ ()=>{ setSelectedTab("Products")
        ...
        <a href="#" class={`nav-link text-white ${ selectedTab === "Products" && "active"}`}>
      ...
      <li onClick={ ()=>{ setSelectedTab("Customers")
        ...
        <a href="#" class={`nav-link text-white ${ selectedTab === "Customers" && "active"}`}>
